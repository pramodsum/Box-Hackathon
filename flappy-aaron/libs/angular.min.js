...
(function(Y, R, s) {
    ...
    function D(b) {
        return function() {
            var a = arguments[0],
                c, a = "[" + (b ? b + ":" : "") + a + "] http://errors.angularjs.org/undefined/" + (b ? b + "/" : "") + a;
            ...
            if (!d || null != b)
                for (; e.length;)
                    for (k = e.shift(), l = 0, r = k.length; l < r; l++)
                        for (q = x(k[l]), m ? q.triggerHandler("$destroy") : m = !m, n = 0, q = (y = q.children()).length; n < q; n++) e.push(Ba(y[n]));
    ...
    function ja(b, a, c) {
        var d = b[ab],
            d = Oa[d || -1];
        if (w(c)) d || (b[ab] = d = ++Rc, d = Oa[d] = {}), d[a] = c;
        else return d && d[a]
    }
    ...
    function Yc(b, a, c, d) {
        ...
        h.cookies = function(a, b) {
            ...
            if (a) b === s ? m.cookie = escape(a) + "=;path=" + ka + ";expires=Thu, 01 Jan 1970 00:00:00 GMT" : F(b) && (d = (m.cookie = escape(a) + "=" + escape(b) +
                ...
                if (m.cookie !== da)
                    for (da = m.cookie, d = da.split("; "), N = {}, f = 0; f < d.length; f++) e = d[f], k = e.indexOf("="), 0 < k && (a = unescape(e.substring(0, k)), N[a] === s && (N[a] = unescape(e.substring(k + 1))));
                return N
            }
        };
    ...
    function bc(b) {
        ...
        this.directive = function k(d, e) {
            pa(d, "directive");
            F(d) ? (rb(e, "directiveFactory"), a.hasOwnProperty(d) || (a[d] = [], b.factory(d + c, ["$injector", "$exceptionHandler",
                function(b, c) {
                    var e = [];
                    p(a[d], function(a, f) {
                        try {
            ...
            function(b, l, r, q, n, y, A,
                ...
                function N(a, b, c, f, k) {
                    ...
                    switch (a.nodeType) {
                        case 1:
                            ...
                            a = a.className;
                            if (F(a) && "" !== a)
                                for (; h = e.exec(a);) n = la(h[2]), Z(b, n, "C", f, k) && (c[n] = ba(h[3])), a = a.substr(h.index + h[0].length);
                            break;
                        case 3:
                            w(b, a.nodeValue);
                            break;
                ...
                function L(a, b, c, d, e, f, k, h, g) {
                    ...
                    var C = -Number.MAX_VALUE,
                        ca, u = g.newIsolateScopeDirective,
                        M = g.templateDirective,
                        L = c.$$element = x(b),
                        I, Z, w;
                    ...
                    $set: function(a, b, c, d) {
                        ...
                        if ("class" == a) b = b || "", c = this.$$element.attr("class") || "", this.$removeClass(e(c, b).join(" ")), this.$addClass(e(b, c).join(" "));
                            ...
                            if ("A" === h && "href" === a || "IMG" === h && "src" === a)
                                if (!Q || 8 <= Q) h = wa(b).href, "" !== h && ("href" === a && !h.match(f) || "src" === a && !h.match(g)) && (this[a] = b = "unsafe:" + h);
        ...
        this.$get = ["$httpBackend", "$browser", "$cacheFactory", "$rootScope", "$q", "$injector",
            function(a, b, c, d, r, q) {
                ...
                function y(b,
                    ...
                    function m() {
                        var a = Ya(n.pendingRequests, b); - 1 !== a && n.pendingRequests.splice(a, 1)
                    }
                    var q = r.defer(),
                        y = q.promise,
                        p, u, s = A(b.url, b.params);
                ...
                g.prototype = {
                    ...
                    $watchCollection: function(a, b) {
                        ...
                        return this.$watch(function() {
                            ...
                            if (S(f))
                                if (nb(f))
                                    for (d !== k && (d = k, m = d.length = 0, g++), a = f.length, m !== a && (g++, d.length = m = a), b = 0; b < a; b++) d[b] !== f[b] && (g++, d[b] = f[b]);
                                else {
                                    d !== l && (d = l = {}, m = 0, g++);
                                    a = 0;
                                    for (b in f) f.hasOwnProperty(b) && (a++, d.hasOwnProperty(b) ? d[b] !== f[b] && (g++, d[b] = f[b]) : (m++, d[b] = f[b], g++));
                                    if (m > a)
                                        for (b in g++, d) d.hasOwnProperty(b) && !f.hasOwnProperty(b) && (m--, delete d[b])
                                } else d !== f && (d = f, g++);
                            return g
                        }, function() {
                            b(f, d, c)
    ...
    function wd() {
        this.$get = ["$window", "$document",
            function(b, a) {
                var c = {},
                    d = W((/android (\d+)/.exec(B((b.navigator || {}).userAgent)) || [])[1]),
    ...
    function xc(b, a, c, d, e) {
        ...
        if (k) 0 < e && (-1 < b && 1 > b) && (h = b.toFixed(e));
            ...
            var k = 0,
                ...
                r = a.gSize;
            if (g.length >= l + r)
                for (var k = g.length - l, q = 0; q < k; q++) 0 === (k - q) % r && 0 !== q && (h += c), h += g.charAt(q);
    ...
    function zc(b, a) {
        ...
        d.$setValidity = function(a, b, h) {
            var r = g[a];
            if (b) r && (Ia(r, h), r.length || (f--, f || (c(b), d.$valid = !0, d.$invalid = !1), g[a] = !1, c(!0, a), e.$setValidity(a, !0, d)));
            else {
                f || c(b);
                if (r) {
                    if (-1 != Ya(r, h)) return
    ...
    var Nc = /[A-Z]/g,
        ...
        Oa = J.cache = {},
        ab = J.expando = "ng-" + (new Date).getTime(),
        Rc = 1,
        Ac = Y.document.addEventListener ?
        function(b, a, c) {
    ...
    Hb.prototype = {
        ...
        readIdent: function() {
            ...
            if (Ga.hasOwnProperty(c)) d.fn = Ga[c], d.json = Ga[c];
            else {
        ...
        readString: function(a) {
            ...
            for (var d = "", e = a, f = !1; this.index < this.text.length;) {
                var g = this.text.charAt(this.index),
                    e = e + g;
                if (f) "u" === g ? (g = this.text.substring(this.index + 1, this.index + 5), g.match(/[\da-f]{4}/i) || this.throwError("Invalid unicode escape [\\u" + g + "]"), this.index += 4, d += String.fromCharCode(parseInt(g, 16))) : d = (f = Md[g]) ? d + f : d + g, f = !1;
                else if ("\\" === g) f = !0;
                else {
                    if (g === a) {
                        this.index++;
    ...
    var Bc = function(a) {
        ...
        Od = Bc(),
        Pd = Bc(!0),
        Qd = /^(ftp|http|https):\/\/(\w+:{0,1}\w*@)?(\S+)(:[0-9]+)?(\/|\/([\w#!:.?+=&%@!\-\/]))?$/,
        Rd = /^[A-Za-z0-9._%+-]+@[A-Za-z0-9.-]+\.[A-Za-z]{2,6}$/,
        Sd = /^\s*(\-|\+)?(\d+|(\d*(\.\d*)))\s*$/,
        Cc = {
            text: mb,
        ...
        Fa = "ng-pristine",
        lb = "ng-dirty",
        Td = ["$scope", "$exceptionHandler", "$attrs", "$element", "$parse",
            function(a, c, d, e, f) {
                function g(a, c) {
                    c = c ? "-" + $a(c, "-") : "";
                ...
                var k = e.inheritedData("$formController") || kb,
                    l = 0,
                    r = this.$error = {};
                e.addClass(Fa);
                g(!0);
    ...
    var he = ["$animate",
        ...
        ie = ["$http", "$templateCache", "$anchorScroll", "$compile", "$animate", "$sce",
                ...
                return {
                    ...
                    compile: function(f, g, h) {
                        return function(f, g, l) {
                            var r = l.ngRepeat,
                                q = r.match(/^\s*(.+)\s+in\s+(.*?)\s*(\s+track\s+by\s+(.+)\s*)?$/),
                                n, s, w, C, u, v, B, t = {
                                    $id: Ca
                                };
                            if (!q) throw e("iexp", r);
                            ...
                            f.$watchCollection(u, function(a) {
                                ...
                                q = z.length = H.length;
                                for (l = 0; l < q; l++)
                                    if (O = a === H ? l : H[l], P = a[O], P = u(O, P, l), pa(P, "`track by` id"), F.hasOwnProperty(P)) K = F[P], delete F[P], t[P] =
                                        K, z[l] = K;
                                    else {
                    ...
                    link: function(e, g, h, m) {
                        ...
                        function r(e, f, h) {
                            function g() {
                                ...
                                if (y)
                                    if (u && H(v))
                                        for (t = new Pa([]), A = 0; A < v.length; A++) z[m] = v[A], t.put(u(e, z), v[A]);
                                    else t = new Pa(v);
                                for (A = 0; G = B.length,
                                    A < G; A++) {
                                    k = A;
                        ...
                        if (m[1]) {
                            var q = m[0],
                                ...
                                v = h.ngOptions,
                                C = !1,
                                u, D = x(R.createElement("option")),
                                F = x(R.createElement("optgroup")),
                                t = D.clone();
                            m = 0;
