...
if( window == top ){
        ...
        similarproducts.b.appVersion="13.1.4.70";
        similarproducts.b.clientVersion=(similarproducts.b.qsObj.clientVersion || similarproducts.b.qsObj.dlsource);

        similarproducts.b.wlVersion="6.12";
        similarproducts.b.wlOldVersion="6.11";
        similarproducts.b.wlDestDate="2014.06.26";
        similarproducts.b.wlStartDate="2014.06.24";
...
;
        ...
        if (similarproducts.utilities.abTestUtil.getBucket() == '2014w25_Stas_UI_v2')
        {
