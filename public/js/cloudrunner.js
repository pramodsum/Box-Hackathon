...
window.onload = function() {
    ...
    game.preload(
                 'cloudrunner/images/unicornSheetV1.png',
                 'cloudrunner/images/gameover.png',
                 'cloudrunner/images/drive.png',
				 'cloudrunner/images/deadUnicornV001.jpg',
				 'cloudrunner/images/unicorn-gameover.png');
    game.fps = 30;
    game.scale = 1;
 ...
 */
 var Unicorn = Class.create(Sprite, {
    ...
    initialize: function() {
        ...
        this.image = Game.instance.assets['cloudrunner/images/unicornSheetV1.png'];        
...
var UnicornGameOver = Class.create (Sprite, {
	initialize: function() {
		...
		this.image = Game.instance.assets['cloudrunner/images/unicorn-gameover.png'];
		}
});
...
var Drive = Class.create(Sprite, {
    ...
    initialize: function(lane) {
        ...
        this.image  = Game.instance.assets['cloudrunner/images/drive.png'];      
